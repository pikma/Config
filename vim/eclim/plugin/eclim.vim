...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/usr/local/google/users/kreitmann/eclipse38/testing/plugins/org.eclim_1.7.13'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/usr/local/google/users/kreitmann/eclipse38/testing'
  if has('win32unix')
