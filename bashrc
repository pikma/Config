...
#export ROS_PACKAGE_PATH=/home/pierre/Documents/Stanford/cs225B:/opt/ros/cturtle/stacks
#export STAGEPATH=/etc/X11/:${STAGEPATH}
#export PATH=/home/pierre/.opt:${PATH}


CDPATH=:/home/pierre/Documents/Stanford/
