...
return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>,m", builtin.keymaps, { desc = "Search key [M]appings" })
      ...
      vim.keymap.set("n", "<leader>,w", builtin.diagnostics, { desc = "Find diagnostics (telescope)" })
		end,
	},
}
